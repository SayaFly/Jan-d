...
{    
   /**
    ...
    const client = [
      "nitro" => [
          "http://185.254.97.28/client/Dark" => "Nitro Client",
    ...
    const site = [
      "domain"      => "http://185.254.97.28",
      "cpath"       => "http://185.254.97.28/client/ASSETS/c_images",
      "fpath"       => "http://habbo.nl/imaging/avatarimage",
      "shortname"   => "Habbo",
      "sitename"    => "Habbo"
    ];
